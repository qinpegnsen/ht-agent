...
@Component({
  selector: 'app-message-inform',
  templateUrl: './message-inform.component.html',
  styleUrls: ['./message-inform.component.scss']
})
export class MessageInformComponent implements OnInit {
  ...
  constructor(public messageInformService:MessageInformService) { }
  ...
  queryAgentTpl(event?:PageEvent){
    ...
    this.agentTplData=new Page(this.messageInformService.linkGoods(url,data));
  }
